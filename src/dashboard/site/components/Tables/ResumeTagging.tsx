                ...
                <TableContainer component={Paper}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        catalogEntry.archives.map((archiveEntry,arcIndex)=> (
                            ...
                            <TableCell align="center">{archiveEntry.archiveName}</TableCell>
                            <TableCell align="center">{archiveEntry.tagged}/{archiveEntry.total}</TableCell>
                            <TableCell align="center">
                                <Button variant="contained" color="primary" onClick ={()=>location.href = archiveEntry.link}>
                                    Resume
                                </Button>
                            </TableCell>
                            </TableRow>
